...
class Home:
	...
	def home(self): 
		print(f"""{Color.LG}
        _______ _    _ ______ _   _            _____  _____   ____   _____ 
     /\|__   __| |  | |  ____| \ | |   /\     |  __ \|  __ \ / __ \ / ____|
    /  \  | |  | |__| | |__  |  \| |  /  \    | |  | | |  | | |  | | (___  
   / /\ \ | |  |  __  |  __| | . ` | / /\ \   | |  | | |  | | |  | |\___ \ 
  / ____ \| |  | |  | | |____| |\  |/ ____ \  | |__| | |__| | |__| |____) |
 /_/    \_\_|  |_|  |_|______|_| \_/_/    \_\ |_____/|_____/ \____/|_____/ 
...
""")
		...
		while True:
			sys.stdout.write(Color.LB+"📌 "+Color.LR+"["+Color.LG+"Phạm Thế Sơn""]"+Color.LB+"\n➠ "+Color.RESET)
			option = input()
...
if __name__ == '__main__':
	...
	contact = f"""Facebook: https://www.facebook.com/SAD.WALL2003\nZalo: 0336475811"""
